...
//         mockMvc = MockMvcBuilders.standaloneSetup(new TokenController(concertFacade)).build();
...
//         Mockito.when(concertFacade.checkQueueStatus(anyString())).thenThrow(new TokenInvalidStatusException());
